...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, entity_embed, triplet_embed, pos_embed, so_embed, freq_prior_matrix):
        ...
        mean = 0.0
        stddev = 0.1
        noise = (torch.randn(150, 150) * stddev + mean) * 10000
        noisy_tensor = freq_prior_matrix + noise
        freq_prior = self.freq_prior_mlp(noisy_tensor.cuda())
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation="relu"):
        ...
        self.key_scale1 = nn.Linear(100,256)
        self.key_scale2 = nn.Linear(256,512)
        self.key_scale3 = nn.Linear(512,805)
    ...
    def forward(self, tgt_entity, tgt_triplet, entity_pos, triplet_pos, so_pos,
        ...
        sub_k1 = tgt_entity.permute(1, 2, 0)
        sub_k1 = self.key_scale1(sub_k1)
        sub_k1 = self.key_scale2(sub_k1)
        sub_k1 = self.key_scale3(sub_k1)
        # sub_k1 = sub_k1.permut
        # memory = memory + sub_k1
